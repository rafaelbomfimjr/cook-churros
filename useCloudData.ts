// Hook centralizado para persistência de dados na nuvem (Vercel KV)
// Substitui todos os localStorage.getItem/setItem do app
...
export function useInsumos() {
  ...
  useEffect(() => {
    apiGet<Insumo[]>("/api/insumos").then((data) => {
      ...
      // Se não havia nada no banco, sobe os defaults
